...
pricing = tree.xpath('//span[@data-plan=\
        "free" and @class="js-computed-value"]/text()')[0]
print("Plan:", plans[0], "\nPricing:", pricing)
pricing = tree.xpath('//span[@data-plan="business"\
        and @class="js-computed-value"][1]/text()')[0]
print("Plan:", plans[1], "\nPricing:", pricing)
pricing = tree.xpath(
