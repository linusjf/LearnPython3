...
print(
    joint_prob_table[
        gender_mapping["female"], department_mapping["C"], admission_mapping["admitted"]
    ]
)
...
print()
print("Probability Admission|Gender=Male Dept-wise (A-F)")
print(
    prob_admission_given_male_A,
    prob_admission_given_male_B,
    prob_admission_given_male_C,
    prob_admission_given_male_D,
    prob_admission_given_male_E,
    prob_admission_given_male_F,
    sep=" ",
)
print()
print("Probability Admission|Gender=Female Dept-wise (A-F)")
print(
    prob_admission_given_female_A,
    prob_admission_given_female_B,
    prob_admission_given_female_C,
    prob_admission_given_female_D,
    prob_admission_given_female_E,
    prob_admission_given_female_F,
    sep=" ",
)
...
for department in department_labels:
    for gender in gender_labels:
        ...
        print(
            department,
            gender,
            dict(zip(admission_labels, restricted / np.sum(restricted)))["admitted"],
        )
