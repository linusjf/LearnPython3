...
#  Default: '/root/LearnPython3/ipyparallel'
# c.BaseParallelApplication.work_dir = '/root/LearnPython3/ipyparallel'
...
# c.IPClusterEngines.work_dir = '/root/LearnPython3/ipyparallel'
...
## Set the working dir for the process.
#  See also: BaseParallelApplication.work_dir
# c.IPClusterStart.work_dir = '/root/LearnPython3/ipyparallel'
...
# c.BatchControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.HTCondorControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.LSFControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.MPIControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.PBSControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.SGEControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.SlurmControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'ipyparallel.controller']
...
## Popen command to launch ipcontroller.
#  See also: ControllerLauncher.controller_cmd
# c.SSHControllerLauncher.controller_cmd = ['/usr/bin/python', '-m', 'ipyparallel.controller']
...
# c.EngineLauncher.engine_args = ['--log-level=20']
...
# c.BatchEngineSetLauncher.engine_args = ['--log-level=20']

## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.BatchEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'ipyparallel.engine']
...
## command-line arguments to pass to ipengine
#  See also: EngineLauncher.engine_args
# c.HTCondorEngineSetLauncher.engine_args = ['--log-level=20']

## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.HTCondorEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'ipyparallel.engine']
...
## command-line arguments to pass to ipengine
#  See also: EngineLauncher.engine_args
# c.LocalEngineLauncher.engine_args = ['--log-level=20']
...
## command-line arguments to pass to ipengine
#  See also: EngineLauncher.engine_args
# c.LSFEngineSetLauncher.engine_args = ['--log-level=20']

## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.LSFEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.MPIEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'ipyparallel.engine']
...
## command-line arguments to pass to ipengine
#  See also: EngineLauncher.engine_args
# c.SGEEngineSetLauncher.engine_args = ['--log-level=20']

## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.SGEEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'ipyparallel.engine']
...
## command-line arguments to pass to ipengine
#  See also: EngineLauncher.engine_args
# c.SlurmEngineSetLauncher.engine_args = ['--log-level=20']

## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.SlurmEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'ipyparallel.engine']
...
## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.SSHEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'ipyparallel.engine']
...
## command-line arguments to pass to ipengine
#  See also: EngineLauncher.engine_args
# c.SSHProxyEngineSetLauncher.engine_args = ['--log-level=20']

## command to launch the Engine.
#  See also: EngineLauncher.engine_cmd
# c.SSHProxyEngineSetLauncher.engine_cmd = ['/usr/bin/python', '-m', 'ipyparallel.engine']
