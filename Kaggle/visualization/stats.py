...
plot = sns.relplot(x="total_bill", y="tip", hue="smoker", style="smoker", data=tips)
pp.savefig()
plot.figure.clear()
...
plot = sns.relplot(x="timepoint", y="signal", hue="region", style="event", kind="line", data=fmri)
pp.savefig()
plot.figure.clear()
...
plot = sns.relplot(x="timepoint", y="signal", hue="event", style="event", kind="line", data=fmri)
pp.savefig()
plot.figure.clear()
...
df = pd.DataFrame(
    dict(time=pd.date_range("2017-1-1", periods=500), value=np.random.randn(500).cumsum())
)
g = sns.relplot(x="time", y="value", kind="line", data=df)
g.figure.autofmt_xdate()
pp.savefig()
...
plot = sns.relplot(x="total_bill", y="tip", hue="smoker", col="time", data=tips)
pp.savefig()
plot.figure.clear()
