...
print(prob_admission_given_male_A,prob_admission_given_male_B,prob_admission_given_male_C,prob_admission_given_male_D,prob_admission_given_male_E,prob_admission_given_male_F,sep=" ")
print()
